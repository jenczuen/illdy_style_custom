...
/******************* General *******************/
/***********************************************/
$wp_customize->add_section( $prefix . '_custom_panel_general' ,
    array(
        'title'         => __( 'Custom Panel Section', 'illdy' ),
        'description'   => __( 'Control various options for custom panel section from front page.', 'illdy' ),
        'priority'      => illdy_get_section_position($prefix . '_custom_panel_general'),
        'panel' 	    => 'illdy_frontpage_panel'
    )
);

// Show this section
$wp_customize->add_setting( $prefix . '_custom_panel_general_show',
    array(
...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize,
    $prefix . '_custom_panel_general_show',
    array(
        'type'      => 'mte-toggle',
        'label'     => __( 'Show this section?', 'illdy' ),
        'section'   => $prefix . '_custom_panel_general',
        'priority'  => 1
    ) )
);
