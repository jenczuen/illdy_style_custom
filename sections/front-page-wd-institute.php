...
$button_url = home_url() . "/index.php/category/institute/";

if ( $post_query->have_posts()) {

	?>

	<section id="wd_institute" class="front-page-section wd_posts_view">
				...
				<div class="container">
					<div class="row blog-carousel">
						...
						<?php while ( $post_query->have_posts() ): ?>
							...
							<div class="illdy-blog-post col-md-4 col-sm-6 col-xs-12 wd_institute_post_container">

								<div class="post wd_institute_post_text" style="<?php 
									if ( ! $post_thumbnail && 
